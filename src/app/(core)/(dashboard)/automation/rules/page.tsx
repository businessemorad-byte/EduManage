    ...
    return (
      <div className="p-6 max-w-5xl mx-auto">
        <div className="rounded-xl border border-red-200 bg-red-50 p-6 text-center">
          <p className="text-sm text-red-600">Failed to load rules.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6 p-6 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="rounded-xl border border-zinc-200 bg-white p-4">
          ...
          <p className="text-2xl font-bold text-zinc-900 mt-1">{rules.length}</p>
        </div>
        <div className="rounded-xl border border-zinc-200 bg-white p-4">
        ...
        <div className="rounded-xl border border-zinc-200 bg-white p-4">
          ...
          <p className="text-2xl font-bold text-amber-600 mt-1">{rules.length - activeCount}</p>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 text-sm border border-zinc-200 rounded-lg bg-white text-zinc-900 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-brand-500"
          />
        </div>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2.5">
                    <Link
                      ...
                      className="text-sm font-semibold text-zinc-900 hover:text-brand-600"
                    >
                      {rule.name}
                    </Link>
                    <span
                ...
                <div className="flex items-center gap-2 ml-4">
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg border border-zinc-200 hover:bg-zinc-50 text-zinc-600 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg border border-red-200 hover:bg-red-50 text-red-600 transition-colors"
                  >
