    ...
    <div className="mx-auto max-w-lg p-8">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        ...
        <div>
          ...
          <input name="name" required className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input name="weight" type="number" min="0" max="100" step="0.1" className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
          </div>
          <div>
            <label className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">Date</label>
            <input name="date" type="date" className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 text-sm dark:border-zinc-700 dark:bg-zinc-900" />
          </div>
        </div>
