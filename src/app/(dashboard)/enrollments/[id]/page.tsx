            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="flex items-center gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-white">{studentName}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-white">{enrollment.group?.name ?? "—"}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-white">{enrollment.academicYear?.name ?? "—"}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-white">{enrollment.program?.name ?? "—"}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-white">{enrollment.subject?.name ?? "—"}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Calendar className="h-4 w-4 text-zinc-400" />
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-white">{new Date(enrollment.startDate).toLocaleDateString()}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <Calendar className="h-4 w-4 text-zinc-400" />
                <div>
                  ...
                  <p className="font-medium text-zinc-900 dark:text-white">{enrollment.endDate ? new Date(enrollment.endDate).toLocaleDateString() : "—"}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
            ...
            <div className="space-y-2">
              <button onClick={() => router.push(`/students/${enrollment.student.id}`)} className="flex w-full items-center gap-2 rounded-lg bg-brand-50 px-3 py-2 text-sm font-medium text-brand-700 hover:bg-brand-100 dark:bg-brand-900/20 dark:text-brand-400">
