    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 gap-4 lg:grid-cols-5">
        <div className="rounded-lg border border-zinc-200 bg-white p-4">
          ...
          <p className="mt-1 text-2xl font-bold text-zinc-900">{o.students.totalStudents}</p>
      ...
      <div className="rounded-lg border border-zinc-200 bg-white p-4">
        ...
        {report && (
          <pre className="mt-4 whitespace-pre-wrap rounded-lg bg-zinc-50 p-4 text-sm text-zinc-700">
            {report}
          </pre>
        )}
      </div>
