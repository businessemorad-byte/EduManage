  ...
  if (!data) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        ...
        <h3 className="text-sm font-semibold text-zinc-900">Failed to load dashboard</h3>
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div className="rounded-xl border border-zinc-100 bg-white p-5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-zinc-500">Taux de présence</span>
          </div>
        ...
        <div className="rounded-xl border border-zinc-100 bg-white p-5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-zinc-500">Impayés</span>
          </div>
          <p className="mt-3 text-3xl font-bold tracking-tight text-zinc-900">
        ...
        <div className="rounded-xl border border-zinc-100 bg-white p-5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-zinc-500">Revenu mensuel</span>
          </div>
          <p className="mt-3 text-3xl font-bold tracking-tight text-zinc-900">
        ...
        <div className="rounded-xl border border-zinc-100 bg-white p-5">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-medium text-zinc-500">Salles disponibles</span>
          </div>
          <p className="mt-3 text-3xl font-bold tracking-tight text-zinc-900">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {quickActions.map((action) => (
            <Link
              key={action.href}
              href={action.href}
              className="group flex items-center gap-3 rounded-lg border border-zinc-100 bg-zinc-50 px-4 py-3 transition-all hover:border-brand-200 hover:bg-brand-50"
            >
              <span className="text-zinc-400 transition-colors group-hover:text-brand-600">
                {action.icon}
              </span>
              <span className="text-sm font-medium text-zinc-700 transition-colors group-hover:text-brand-700">
                {action.label}
              </span>
              <ArrowUpRight className="ml-auto h-3.5 w-3.5 text-zinc-300 transition-all group-hover:translate-x-0.5 group-hover:-translate-y-0.5 group-hover:text-brand-500" />
            </Link>
          ))}
        </div>
      </div>
