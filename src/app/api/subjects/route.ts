...
import { createSubject, listSubjects } from "@/lib/academic";
...
export async function GET(request: Request) {
  try {
    ...
    const subjects = await listSubjects(organizationId, {
...
export async function POST(request: Request) {
  try {
    ...
    const subject = await createSubject({ ...body, organizationId });
