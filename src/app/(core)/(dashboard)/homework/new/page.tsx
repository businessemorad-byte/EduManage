    ...
    <div className="mx-auto max-w-lg p-8">
      ...
      <form onSubmit={handleSubmit} className="mt-6 space-y-4">
        ...
        <div>
          ...
          <input name="title" required className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 text-sm" />
        </div>
        ...
        <div>
          ...
          <textarea name="instructions" rows={3} className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 text-sm" />
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-zinc-700">Subject</label>
            <select name="subjectId" className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 text-sm">
          ...
          <div>
            <label className="block text-sm font-medium text-zinc-700">Group</label>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input name="deadline" type="datetime-local" className="mt-1 block w-full rounded-md border border-zinc-300 px-3 py-2 text-sm" />
          </div>
          <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <label className="text-sm font-medium text-zinc-700">Publish immediately</label>
        </div>
