  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <Link href="/homework/new" className="rounded-md bg-zinc-900 px-4 py-2 text-sm font-medium text-white hover:bg-zinc-800">
          Assign Homework
        </Link>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {data.homeworks.map((h) => (
            <div key={h.id} className="rounded-lg border border-zinc-200 bg-white p-4">
